...
function Details(props) {
  ...
  return (
    <div className="pickerField">
      <form action="#" className="detailsForm pickerField-loginField" >
        ...
        <div className="row detailsForm-textArea">
          <div className="input-field col s12 ">
            ...
            <textarea onChange={(e) => setNewLog({ ...newLog, comment: e.target.value })} id="icon_prefix2" className="materialize-textarea" rows="20">
            </textarea>
